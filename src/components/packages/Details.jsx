...
//           <div className="col-md-3 col-12 package-content text-center d-flex flex-column" data-aos="fade-up">
...
//             </div>
//           </div>
//           <div className="col-md-3 col-12 package-content text-center d-flex flex-column" data-aos="fade-up" data-aos-delay="500">
...
//                   routine diet instructions and following Do’s and Don’ts given
//                   to client.
//                 </li>
//               </ul>
//             </div>
//           </div>
//           <div className="col-md-3 col-12 package-content text-center d-flex flex-column" data-aos="fade-up" data-aos-delay="1000">
...
//                 </li>
//                 <li>
//                   An Exercise planner will be given with this package for Body
//                   tone up and spot reductions fat loss (eg: Arms, Buttocks,
//                   Waistline, Thighs)
//                 </li>
//               </ul>
//             </div>
